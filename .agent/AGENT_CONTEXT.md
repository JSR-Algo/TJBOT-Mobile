...
sys-16 does NOT own:
- Backend API contract definitions → tjbot-backend (sys-01, sys-02, sys-04, etc.)
...
| `rotjtjbot-mgmt/` | 12 screens | DevicesTab | |
...
| features-device-parent | `src/features/{device,parent,progress,purchase,rotjtjbot-mgmt}/**` |
| testing | `tests/**` |
