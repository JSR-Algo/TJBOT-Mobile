...
public class ParentSessionAssignmentBridgeTest {
    ...
    private static final String ARMING_VALUE = "PASS52";
    private static final String RESULT_NAME = "t54-pass52-assignment.json";
    ...
    @Test
    public void createPass52Assignment() throws Exception {
        Instrumentation instrumentation = InstrumentationRegistry.getInstrumentation();
    ...
    private static JSONObject postAssignmentOnce(String accessToken) throws Exception {
        ...
        try {
            ...
            connection.setRequestProperty("X-Request-Id", "t54-pass52-parent-session-bridge");
