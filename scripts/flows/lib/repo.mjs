...
import { APP_ROOT, SRC_ROOT, DOCS_ROOT } from '../../_lib/paths.mjs';
...
export const FEATURES_DIR = path.join(APP_ROOT, 'src', 'features');
export const DOCS_FLOWS_DIR = path.join(DOCS_ROOT, 'flows');
