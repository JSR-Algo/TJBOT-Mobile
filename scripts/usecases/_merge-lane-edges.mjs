...
const LANE = [
  ...
  ['UC-L05', 'ACTOR:RealtimeVoice', 'delegate', 'Lane B: rotjtjbot speech via voice'],
  ...
  ['UC-PR06', 'ACTOR:Rotjtjbot', 'delegate', 'Lane C: firmware test delegate'],
  ...
  ['UC-CL07', 'UC-CL08', 'continues', 'Lane D: rotjtjbot ready → monitor'],
  ['UC-CL08', 'UC-CL09', 'continues', 'Lane D: monitor → companion view'],
  ['UC-DM03', 'ACTOR:Rotjtjbot', 'delegate', 'Lane D: chime delegate (already present, dup-skip)'],
  ['UC-DM04', 'ACTOR:Rotjtjbot', 'delegate', 'Lane D: firmware delegate (already present, dup-skip)'],
