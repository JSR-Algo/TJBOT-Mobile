...
export const DEVICE_SCREENS = defineFeatureScreens([
  ...
  { name: ROUTES.PairAddScreen, component: PairAddScreen, role: 'stack-entry', backTarget: ROUTES.DeviceOverviewScreen, stateMachineId: 'dv_pair_add' },
  { name: ROUTES.PairRenameScreen, component: PairRenameScreen, role: 'stack-entry', backTarget: ROUTES.PairSuccessScreen, forwardCycleGroup: 'device-pairing-retry', stateMachineId: 'dv_pair_rename' },
