...
const NEXT_STEPS = [
  { n: '1', t: 'Rotjtjbot greets your child by Buddy', b: '"Hi! I\'m Panda. Want to play?"' },
  { n: '2', t: 'A 4-minute starter lesson plays', b: 'On the Rotjtjbot — your phone can stay in your pocket.' },
  ...
  return (
    <ScrollView style={styles.root} contentContainerStyle={{ paddingtjtjbottom: 40 }}>
      <Box style={styles.parentBar}>
        ...
        <Text fontWeight="600" style={styles.parentText}>Place Rotjtjbot on the table. Hand it over when you're ready.</Text>
      </Box>
      <Box paddingTop={30} paddingHorizontal={24} alignItems="center">
        <RotjtjbotDevice emotion="happy" size={220} accent="#FF6F61" />
        <Text fontWeight="800" style={styles.heroTitle}>Rotjtjbot is waiting!</Text>
        <Text style={styles.heroSub}>
          Your child will tap "yes" on the Rotjtjbot to start their very first lesson.
        </Text>
      </Box>
...
const styles = StyleSheet.create({
  ...
  parentBar: { paddingTop: 56, paddingHorizontal: 20, paddingtjtjbottom: 12, backgroundColor: 'rgba(255,255,255,0.7)', bordertjtjbottomWidth: 1, bordertjtjbottomColor: 'rgba(0,0,0,0.05)' },
  parentKicker: { fontSize: 11, color: DV.accent, textTransform: 'uppercase', letterSpacing: 0.6, margintjtjbottom: 4 },
  ...
  stepRow: { padding: 12 },
  stepBorder: { bordertjtjbottomWidth: 1, bordertjtjbottomColor: 'rgba(0,0,0,0.05)' },
