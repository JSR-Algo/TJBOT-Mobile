    ...
    <DeviceShell title="Software update" onBack={() => navigation.navigate('DeviceHomeScreen')}>
      <Box paddingHorizontal={16} paddingTop={24}>
        <Box style={styles.heroCard} flexDirection="row" gap={14} alignItems="center">
          <RotjtjbotDevice emotion="charging" size={84} accent="#FF6F61" />
          <Box flex={1}>
            ...
            <Text style={styles.versionMeta}>About 4 minutes · Rotjtjbot will be unavailable</Text>
          </Box>
        </Box>
      </Box>
      ...
      <Box paddingHorizontal={20} paddingTop={24} paddingtjtjbottom={30} gap={10}>
        ...
        <Text style={styles.note}>Tonight's update happens during quiet hours so Rotjtjbot is ready in the morning.</Text>
      </Box>
    </DeviceShell>
  );
}
...
const styles = StyleSheet.create({
  ...
  listBorder: { bordertjtjbottomWidth: 1, bordertjtjbottomColor: DV.hair },
