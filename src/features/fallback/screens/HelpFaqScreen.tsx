...
const FAQS = [
  ...
  { q: 'Why does the app need a microphone?', a: "Speaking practice is the core of Rotjtjbot English. The mic only turns on during a lesson." },
  { q: 'My child is shy — will the rotjtjbot wait?', a: 'Yes. The rotjtjbot uses gentle prompts and never penalizes silence. Children can pause anytime.' },
          ...
          {FAQS.map((f, i) => {
            ...
            return (
              ...
              >
                ...
                {isOpen ? (
                  <Box paddingHorizontal={14} paddingtjtjbottom={14}>
...
const styles = StyleSheet.create({
  ...
  faqItemBorder: { bordertjtjbottomWidth: 1, bordertjtjbottomColor: 'rgba(0,0,0,0.07)' },
  ...
  sectionHeader: { fontSize: 12, color: '#8B8B96', letterSpacing: 0.8, fontWeight: '600', paddingtjtjbottom: 8 },
  ...
  helpRowBorder: { bordertjtjbottomWidth: 1, bordertjtjbottomColor: 'rgba(0,0,0,0.07)' },
