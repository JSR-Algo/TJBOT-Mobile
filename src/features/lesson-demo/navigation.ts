...
export const LESSON_DEMO_SCREENS = defineFeatureScreens([
  ...
  { name: ROUTES.LessonRoadmapScreen, component: LessonRoadmapScreen, role: 'stack-entry', backTarget: ROUTES.LessonDemoHomeScreen, forwardCycleGroup: 'lesson-demo-review', stateMachineId: 'lesson_demo_roadmap' },
