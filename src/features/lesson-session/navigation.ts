...
export const LESSON_SESSION_SCREENS = defineFeatureScreens([
  ...
  { name: ROUTES.GreetingScreen, component: GreetingScreen, role: 'state-machine', stateMachineId: 'greeting', ...HIDDEN_LESSON_ROUTE },
  ...
  { name: ROUTES.ActivityIntroScreen, component: ActivityIntroScreen, role: 'state-machine', stateMachineId: 'activity_intro', ...HIDDEN_LESSON_ROUTE },
  { name: ROUTES.ActivityDoneScreen, component: ActivityDoneScreen, role: 'state-machine', stateMachineId: 'activity_done', ...HIDDEN_LESSON_ROUTE },
  ...
  { name: ROUTES.RetryScreen, component: RetryScreen, role: 'state-machine', stateMachineId: 'retry', ...HIDDEN_LESSON_ROUTE },
  { name: ROUTES.SilenceScreen, component: SilenceScreen, role: 'state-machine', stateMachineId: 'silence', ...HIDDEN_LESSON_ROUTE },
  { name: ROUTES.BargeinScreen, component: BargeinScreen, role: 'state-machine', stateMachineId: 'bargein', ...HIDDEN_LESSON_ROUTE },
  { name: ROUTES.GentleScreen, component: GentleScreen, role: 'state-machine', stateMachineId: 'gentle', ...HIDDEN_LESSON_ROUTE },
  { name: ROUTES.OfftopicScreen, component: OfftopicScreen, role: 'state-machine', stateMachineId: 'offtopic', ...HIDDEN_LESSON_ROUTE },
  ...
  { name: ROUTES.ReconnectingScreen, component: ReconnectingScreen, role: 'state-machine', stateMachineId: 'reconnecting', ...HIDDEN_LESSON_ROUTE },
]);
