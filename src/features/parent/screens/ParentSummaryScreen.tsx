...
export default function ParentSummaryScreen({ navigation, route }: Props) {
  ...
  return (
    <ParentScroll title="Parent Space" right={<StateLink navigation={navigation} />}>
      ...
      <PRowGroup header="History"><PRow icon="🗓" label="Lesson history" value={recentLessonLabel} chevron onPress={() => navigation.navigate(ROUTES.ParentHistoryScreen)} isLast /></PRowGroup>
