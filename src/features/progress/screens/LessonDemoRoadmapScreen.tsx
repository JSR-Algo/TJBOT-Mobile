...
type Props = NativeStackScreenProps<RootStackParamList, 'LessonDemoRoadmapScreen'>;

export default function LessonDemoRoadmapScreen({ navigation, route }: Props): React.JSX.Element {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {roadmap.map((week) => (
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(ROUTES.LessonDemoSessionScreen, { week: week.week, day: 1, ageBand })}
        >
...
const styles = StyleSheet.create({
  ...
  weekHeader: { flexDirection: 'row', justifyContent: 'space-between', gap: spacing.sm },
  weekTitle: { ...typography.h3, color: colors.textPrimary },
  month: { ...typography.body2, color: colors.primary, fontWeight: '700' },
  theme: { ...typography.body1, color: colors.textPrimary },
