...
export default function LessonSummaryScreen({ navigation, route }: Props): React.JSX.Element {
  ...
  return (
    <PageScroll bg="#C5F1DD">
      ...
      <Box paddingHorizontal={24} paddingBottom={14}><Box testID={reward ? `reward-${reward.rewardId}` : undefined} style={styles.summaryCard} accessibilityLiveRegion="polite">
