...
export const ROBOT_MGMT_SCREENS = defineFeatureScreens([
  ...
  { name: ROUTES.RobotStatusScreen, component: RobotStatusScreen, role: 'stack', backTarget: ROUTES.MyRobotScreen, stateMachineId: 'rm_status' },
  { name: ROUTES.RobotBatteryScreen, component: RobotBatteryScreen, role: 'stack', backTarget: ROUTES.MyRobotScreen, stateMachineId: 'rm_battery' },
  ...
  { name: ROUTES.FactoryResetScreen, component: FactoryResetScreen, role: 'stack', backTarget: ROUTES.MyRobotScreen, stateMachineId: 'rm_factory' },
  { name: ROUTES.OfflineHelpScreen, component: OfflineHelpScreen, role: 'stack', backTarget: ROUTES.MyRobotScreen, stateMachineId: 'rm_offline_help' },
  { name: ROUTES.SupportScreen, component: SupportScreen, role: 'stack-entry', backTarget: ROUTES.MyRobotScreen, stateMachineId: 'rm_support' },
]);
