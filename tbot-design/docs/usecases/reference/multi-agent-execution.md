...
**Coverage check:** 14 + 37 + 26 + 52 = **129 ✓** (matches AC1).

**Disjoint check:** every one of the 14 domain folders appears in exactly one lane row above. `check-lane-coverage.mjs` enforces.
