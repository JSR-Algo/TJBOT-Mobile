...
function OnbShell({ children, step, total, onBack, title, persona='parent' }){
  return (
    <div data-persona={persona} style={{ height:'100%', overflow:'auto', background:OB.bg, color:OB.ink,
...
function IntroFrame({ go, idx, prev, next, accentBg, kicker, title, body, illo }){
  return (
    <ScreenShell persona="parent" bg={accentBg}>
