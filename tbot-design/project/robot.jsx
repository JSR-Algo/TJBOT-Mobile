...
// All animations are CSS (no deps) so it stays light.

const ROBOT_EMOTES = [
  'idle','happy','greet','listen','think','speak','success','gentle','curious','sleep','sad','worry'
];

// One-time CSS for robot animations
if (typeof document !== 'undefined' && !document.getElementById('robot-styles')) {
...
function Robot({ emotion = 'idle', size = 220, color, accent }){
