...
//   node scripts/i18n/scan-hardcoded.mjs --files a.jsx,b.jsx (override file list — for per-batch gate)
//
...
const filesArg = takeFlagValue('--files');
const FILES_TO_SCAN = filesArg
