...
const html = [
  ...
  '.section{background:#fff;border:1px solid #e3e3e3;border-radius:8px;padding:16px;margin-bottom:24px}',
  'svg{max-width:100%;height:auto}',
  '.nav{position:sticky;top:0;background:#fafafa;padding:8px 0;border-bottom:1px solid #ddd;margin-bottom:16px;z-index:10}',
