...
export default function GreetingScreen({ navigation }: Props) {
  return (
    <ScreenShell>
      <LessonHeader progress={0.05} onExit={() => navigation.navigate('ExitConfirmScreen')} />
      ...
      <Box style={styles.footer}>
        <PrimaryCTA onPress={() => navigation.navigate('ActivityIntroScreen')} color="#7BD389">Yes, let's go!</PrimaryCTA>
      </Box>
    </ScreenShell>
  );
}
