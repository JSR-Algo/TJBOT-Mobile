...
export default function MicTestScreen({ navigation }: Props) {
  ...
  const heading = phase === 'idle' ? 'Can Robot hear you?' : phase === 'listening' ? 'Speak in your normal voice' : 'Robot heard you clearly';
  ...
  return (
    <DeviceShell title="Microphone test" onBack={() => navigation.navigate('MyRobotScreen')}>
      ...
      <Box paddingHorizontal={20} paddingTop={24} paddingBottom={30} gap={10}>
        ...
        {phase === 'done' && (
          <>
            <DeviceBigBtn onClick={() => navigation.navigate('MyRobotScreen')}>Looks good</DeviceBigBtn>
