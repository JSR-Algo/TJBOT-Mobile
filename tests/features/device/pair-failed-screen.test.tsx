...
describe('PairFailedScreen copyForError matrix', () => {
  const cases: { errorCode: string; heading: string; bodyIncludes: string }[] = [
    ...
    { errorCode: 'BLE_SERVICE_UNAVAILABLE', heading: "We couldn't start Bluetooth setup", bodyIncludes: 'Close and reopen the app' },
    {
      ...
      bodyIncludes: 'Robot should already be in setup mode',
    },
    ...
    { errorCode: 'BLE_PROVISIONING_UNSUPPORTED', heading: "Robot didn't accept setup over Bluetooth", bodyIncludes: 'Robot should already be in setup mode' },
    { errorCode: 'BLE_PROVISIONING_FAILED', heading: "Robot didn't accept setup over Bluetooth", bodyIncludes: 'Robot should already be in setup mode' },
    { errorCode: 'BLE_PROVISIONING_DISCONNECTED', heading: "Robot didn't accept setup over Bluetooth", bodyIncludes: 'Robot should already be in setup mode' },
    { errorCode: 'BLE_PROVISIONING_GATT_ERROR', heading: "Robot didn't accept setup over Bluetooth", bodyIncludes: 'Robot should already be in setup mode' },
    { errorCode: 'BLE_PROVISIONING_WRITE_TIMEOUT', heading: "Robot didn't accept setup over Bluetooth", bodyIncludes: 'Robot should already be in setup mode' },
    { errorCode: 'BLE_PROVISIONING_MTU_ERROR', heading: "Robot didn't accept setup over Bluetooth", bodyIncludes: 'Robot should already be in setup mode' },
    { errorCode: 'PAIRING_CONNECT_FAILED', heading: "Robot didn't accept setup over Bluetooth", bodyIncludes: 'Robot should already be in setup mode' },
